...
local filetype_attach = setmetatable({
  ...
  rust = function(_, bufnr)
    buf_set_keymaps(bufnr, {
      { '<leader>dr', "[DAP] Debugger runnables", function()
        vim.cmd.RustLsp('debuggables')
      end },
      { '<leader>rr', "[LSP] Run runnables", function()
        vim.cmd.RustLsp('runnables')
      end },
      { '<leader>me', "[LSP] Rust macro expand", function()
        vim.cmd.RustLsp('expandMacro')
      end },
      { '<leader>mr', "[LSP] Rust macro rebuild", function()
...
M.custom_attach = function(client, bufnr)
  ...
  buf_set_keymaps(bufnr, {
    ...
    { 'gr',         "[LSP] Go to references",          function() require('telescope.builtin').lsp_references() end },
    { 'gi',         "[LSP] Go to implementations",     function() require('telescope.builtin').lsp_implementations() end },
    ...
    { '<leader>rr', "[LSP] Restart LSP Server", function()
      vim.cmd [[ LspRestart ]]
    end },
  })
